class StatisticsController < ApplicationController
  ...
  before_action :set_statistic, only: [:show, :edit, :update, :destroy, :add_late_time]
  ...
  def add_late_time
    ...
    @statistic.late_minutes = params[:minutes]
    @statistic.save
  end
  ...
  private
    ...
    def statistic_params
      params.require(:statistic).permit(:first_yellow, :second_yellow, :red, :goals, :own_goals, :state, :called, :player_id, :match_id)
    end
end
