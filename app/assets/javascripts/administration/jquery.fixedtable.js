...
(function($) {
    ...
    $.fn.fixedTable = function(opts) {
        ...
        $("." + options.classColumn + " ." + options.classHeader + " table tbody tr td", layout).width(options.fixedColumnWidth + "px");
        ...
        if ($(section, src).length) {
            ...
            $(section + " tr", src).each(function() {
                ...
                $(cellType, this).each(function() {
                  if ($(this).attr('class') == "th-match") {
                    $("<td   style='background-color: #3c8dbc'>" + $(this).html() + "</td>").appendTo(tr);
                  }else if ($(this).attr('class') == "th-practice"){
                    $("<td   style='background-color: #add3e8;'>" + $(this).html() + "</td>").appendTo(tr);
                  }else if ($(this).attr('class') == "th-total"){
                    $("<td   style='background-color: #18ca37;'>" + $(this).html() + "</td>").appendTo(tr);
                  }else if ($(this).attr('class') == "th-total-first"){
                    $("<td   style='background-color: #18ca37;'>" + $(this).html() + "</td>").appendTo(tr);
                  }else if ($(this).attr('class') == "th-stat"){
                    $("<td   style='background-color: #87CEFA;'>" + $(this).html() + "</td>").appendTo(tr);
                  }
    ...
    function adjustSizes(options) {
        ...
        $("#" + Id + " .fixedContainer ." + options.classHeader + " table").width((totall + 100) + "px");
        $("#" + Id + " .fixedContainer .fixedTable table").width((totall + 100) + "px");
        $("#" + Id + " .fixedContainer ." + options.classFooter + " table").width((totall + 100) + "px");
